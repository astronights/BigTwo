...
/**
 * Public class to represent a Straight hand of cards.
 * @author shubh31
 *
 */
public class Straight extends Hand implements abstractHand
{
	private static final long serialVersionUID = 1L;
	
	/**
	 * Public constructor to create and initialize a Straight hand by calling the constructor of the superclass.
	 * @param player
	...
	/**
	 * Public getter function to return the type Straight.
	 * @see Hand#getType()
	 */
